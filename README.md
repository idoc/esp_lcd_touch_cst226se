...
Read data from the touch controller and store it in memory. It can be called regularly in poll,
or you might be able to get the IRQ pin to work (I couldn't on my device, a LilyGo T4 S3. YMMV).
